                ...
                <form id="reg-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>"
                    ...
                    <div class="">
                        ...
                        <div class="form-group col-xs-12 signp-group no-left-right-padding">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" class="form-control input-box" data-required="true" name="username"
...
<!--<script type='text/javascript' src='wp-includess/js/jquery/ui/core.mine899.js?ver=1.11.4'></script>-->
...
<!--    var wpcf7 = {-->
<!--        "apiSettings": {-->
<!--            "root": "https:\/\/bit-miner.io\/wp-json\/contact-form-7\/v1",-->
