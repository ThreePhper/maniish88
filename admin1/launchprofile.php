...
$s12=mysqli_query($con,"UPDATE affiliateuser SET launch=1, launch_date = NOW() WHERE username='$tomake'");
if ($r12 || $s12)
{
...
$daily = mysqli_query($con,"UPDATE affiliateuser SET signup_bouns = $pcksbonus  WHERE username='$tomake'");
//else
//{
