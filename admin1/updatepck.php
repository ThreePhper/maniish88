  ...
  $binars="$row[binary]";
                  ...
                  <div class="panel-body">
					...
					<div class="form-group">
                        ...
                        <input type="text" value="<?php print $pckactive ?>" class="form-control" placeholder="" name="pckact">
                      </div>
                      <div class="form-group">
                        <label>Package Name</label>
                        <input type="text" value="<?php print $pname ?>" class="form-control" placeholder="" name="pckname">
                      </div>
                      <div class="form-group">
                        <label>Package Details</label>
                        <input type="textarea" value="<?php print $pdetail ?>" class="form-control" placeholder="" name="pckdetail">
                      </div>
					  
					  <div class="form-group">
                        <label>Package Price</label>
                        <input type="text" value="<?php print $pprice ?>" class="form-control" placeholder="" name="pckprice" >
                      </div>
					  
<div class="form-group">
                        <label>Package Tax</label>
                        <input type="text" value="<?php print $pcktax ?>" class="form-control" placeholder="" name="pcktax" >
                      </div>

<div class="form-group">
                        <label>Minimum Payout For User</label>
                        <input type="text" value="<?php print $pckmpay ?>" class="form-control" placeholder="" name="pckmpay" >
                      </div>
					  
					   <div class="form-group">
                        <label>Signup Bonus</label>
                        <input type="text" value="<?php print $pcksbonus ?>" class="form-control" placeholder="" name="pcksbonus" >
                      </div>
...
<div class="form-group">
                        <label>Level 1</label>
                        <input type="text" value="<?php print $p1 ?>" class="form-control" placeholder="" name="lev1">
                      </div>
					  <div class="form-group">
                        <label>Level 2</label>
                        <input type="text" value="<?php print $p2 ?>" class="form-control" placeholder="" name="lev2">
                      </div>
					  <div class="form-group">
                        <label>Level 3</label>
                        <input type="text" value="<?php print $p3 ?>" class="form-control" placeholder="" name="lev3">
                      </div>
					  <div class="form-group">
                        <label>Level 4</label>
                        <input type="text" value="<?php print $p4 ?>" class="form-control" placeholder="" name="lev4">
                      </div>
					  <div class="form-group">
                        <label>Level 5</label>
                        <input type="text" value="<?php print $p5 ?>" class="form-control" placeholder="" name="lev5">
                      </div>
					  <div class="form-group">
                        <label>Level 6</label>
                        <input type="text" value="<?php print $p6 ?>" class="form-control" placeholder="" name="lev6">
                      </div>
					  <div class="form-group">
                        <label>Level 7</label>
                        <input type="text" value="<?php print $p7 ?>" class="form-control" placeholder="" name="lev7">
                      </div>
					  <div class="form-group">
                       <label>Level 8</label>
                        <input type="text" value="<?php print $p8 ?>" class="form-control" placeholder="" name="lev8">
                      </div>
					  <div class="form-group">
                        <label>Level 9</label>
                        <input type="text" value="<?php print $p9 ?>" class="form-control" placeholder="" name="lev9">
                      </div>
					  <div class="form-group">
                        <label>Level 10</label>
                        <input type="text" value="<?php print $p10 ?>" class="form-control" placeholder="" name="lev10">
                      </div>
					  <div class="form-group">
                        <label>Level 11</label>
                        <input type="text" value="<?php print $p11 ?>" class="form-control" placeholder="" name="lev11">
                      </div>
					  <div class="form-group">
                        <label>Level 12</label>
                        <input type="text" value="<?php print $p12 ?>" class="form-control" placeholder="" name="lev12">
                      </div>
					  <div class="form-group">
                        <label>Level 13</label>
                        <input type="text" value="<?php print $p13 ?>" class="form-control" placeholder="" name="lev13">
                      </div>
					  <div class="form-group">
                       <label>Level 14</label>
                        <input type="text" value="<?php print $p14 ?>" class="form-control" placeholder="" name="lev14">
                      </div>
					  <div class="form-group">
                        <label>Level 15</label>
                        <input type="text" value="<?php print $p15 ?>" class="form-control" placeholder="" name="lev15">
                      </div>
					  <div class="form-group">
                       <label>Level 16</label>
                        <input type="text" value="<?php print $p16 ?>" class="form-control" placeholder="" name="lev16">
                      </div>
					  <div class="form-group">
                       <label>Level 17</label>
                        <input type="text" value="<?php print $p17 ?>" class="form-control" placeholder="" name="lev17">
                      </div>
					  <div class="form-group">
                        <label>Level 18</label>
                        <input type="text" value="<?php print $p18 ?>" class="form-control" placeholder="" name="lev18">
                      </div>
					  <div class="form-group">
                       <label>Level 19</label>
                        <input type="text" value="<?php print $p19 ?>" class="form-control" placeholder="" name="lev19">
                      </div>
					  
					  <div class="form-group">
                       <label>Level 20</label>
                        <input type="text" value="<?php print $p20 ?>" class="form-control" placeholder="" name="lev20">
                      </div>
					  <div class="form-group">
                       <label>Renew Day(s)</label>
                        <input type="text" value="<?php print $validity ?>" class="form-control" placeholder="" name="renewdays">
                      </div>
                     <div class="form-group">
                       <label>Turbo</label>
                        <input type="text" value="<?php print $turb ?>" class="form-control" placeholder="" name="turbo">
                      </div>
                      <div class="form-group">
                       <label>Binary Income</label>
                        <input type="text" value="<?php print $binars ?>" class="form-control" placeholder="" name="binar">
                      </div>
                    </div>
