      ...
      <form action="forgotpasswordck.php" method="post">
        <div class="list-group">
          <div class="list-group-item">
            <input type="email" placeholder="Registered E-Mail" class="form-control no-border" name="femail">
          </div>
          
        </div>
        <button type="submit" class="btn btn-lg btn-primary btn-block">Send Me Password</button>
        <div class="text-center m-t m-b"><a href="index.php"><small>Got The Password?</small></a></div>
...
<footer id="footer">
  <div class="text-center padder">
    <p> <small>Concourse's Multi Level Marketing Script &#174;<br>&copy; 2014</small> </p>
  </div>
</footer>
<!-- / footer -->
<!-- Bootstrap -->
