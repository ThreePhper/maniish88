...
<title>Bit Miner - MLM</title>
<meta name="description" content="Bit Miner.io" />
      ...
      <form action="loginproc.php" method="post" >
        <div class="list-group">
          <div class="list-group-item">
            <input type="text" placeholder="Username" class="form-control no-border" name="username" value="" required>
          </div>
          <div class="list-group-item">
