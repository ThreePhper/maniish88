	   ...
	   ?></strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Admin</span> </span> </a>
              ...
              <nav class="nav-primary hidden-xs">
                <ul class="nav nav-main" data-ride="collapse">
                  ...
                  <li class="active" > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="i i-grid2 icon"> </i> <span class="font-bold">Blog</span> </a>
                    <ul class="nav dk">
                      <li class="active" > <a href="notifications.php" class="auto"><i class="i i-dot"></i> <span>Post Notifications</span> </a> </li>
                  ...
                  <div class="panel-body">
                    ...
                    <form action="postnoti.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="" name="notihead">
                      </div>
                      <div class="form-group">
                        <label>Description</label><br/>
                       <textarea rows="8" cols="125" name="notibody"></textarea>
                      </div>                      
...
while($row = mysqli_fetch_array($result))
{
  ...
  ?>
                     ...
                     <button type="submit" class="btn btn-lg btn-primary btn-block">Oh! I know what i'm doing, Delete this notification</button>
                    </form></div>
