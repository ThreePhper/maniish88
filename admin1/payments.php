...
<head>
<meta charset="utf-8" />
<title>Payments/Receive Money - PayPal</title>
                ...
                <ul class="nav nav-main" data-ride="collapse">
				  ...
				  <li class="active"  > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="fa fa-info-circle"> </i> <span class="font-bold">Analytics</span> </a>
                    <ul class="nav dk">
                      ...
                      <li  class="active"> <a href="payments.php" class="auto"><i class="i i-dot"></i> <span>Paypal Payment Received </span> </a> </li>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <section class="panel panel-success portlet-item">
                  <header class="panel-heading"> Payments/Receive Money - PayPal </header>
