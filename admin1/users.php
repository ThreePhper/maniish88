...
<div class="table-responsive">
          ...
          if($query = "SELECT * FROM affiliateuser  LEFT JOIN packages ON affiliateuser.pcktaken=packages.id WHERE affiliateuser.level= '2' ORDER BY affiliateuser.Id ASC"){
...
while($row = mysqli_fetch_array($result))
{
  ...
  print "<tr>
				  ...
				  <td>$ref</td>
				  <td>$ear</td>
				  <td>$plan $price $cur</td>
				  <td>$doj</td>
				  <td>$status</td>
				  <td><a href='updateuser.php?username=$username'>Edit</a> <br/>
