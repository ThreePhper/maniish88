                  ...
                  <div class="panel-body">
                    ...
                    <form action="updategensettings.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="<?php print $wlink ?>" class="form-control" placeholder="" name="wlink" >
                      </div>
					  <input type="hidden" value="<?php print $sno ?>"  name="sno">
					  <div class="form-group">
                        <label>Name</label>
                        <input type="text" value="<?php print $coname ?>" class="form-control" placeholder="" name="coname">
                      </div>
                      <div class="form-group">
                        <label>Address</label>
                        <input type="textarea" value="<?php print $ide ?>" class="form-control" placeholder="" name="codetail">
                      </div>
					  
					  <div class="form-group">
                        <label>Email Address </label>
                        <input type="email" value="<?php print $email ?>" class="form-control" placeholder="" name="coemail" >
                      </div>
					  ...
					  <br/>
                        ...
                        <input type="email" value="<?php print $pid ?>" class="form-control" placeholder="" name="payemail" >
					  ...
					  <br/>
                        ...
                        <input type="text" value="<?php print $payzaid ?>" class="form-control" placeholder="" name="payzaid" >
                      </div>
					  ...
					  <br/>
                        ...
                        <input type="text" value="<?php print $solidtrustid ?>" class="form-control" placeholder="" name="solidid" >
                      </div>
					  
					  <div class="form-group">
                        <label>SolidTrustPay Button Password (Secondary Password)</label>
                        <input type="text" value="<?php print $solidbuttonid ?>" class="form-control" placeholder="" name="solidbuttonid" >
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" value="<?php print $fblink ?>" class="form-control" placeholder="" name="fblink" >
                      </div>
					  <div class="form-group">
                        <label>Twitter Link</label>
                        <input type="text" value="<?php print $tlink ?>" class="form-control" placeholder="" name="twitterlink" >
                      </div>
					  <div class="form-group">
                        <label>Header Text</label>
                        <input type="text" value="<?php print $hdrtext ?>" class="form-control" placeholder="" name="hdrtext" >
                      </div>
					  <div class="form-group">
                        <label>Footer Text (Leave Blank To Show Nothing )</label>
                        <input type="text" value="<?php print $ftrtext ?>" class="form-control" placeholder="" name="ftrtext" >
                      </div>
					  <div class="form-group">
