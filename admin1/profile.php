...
if (!isset($_SESSION['adminidusername'])) {
  ...
  if(isset($_POST['submit'])){
    ...
    $passs=mysqli_real_escape_string($con,$_POST['p1']);

    $status = "OK";
    $msg="";
    if($status=="OK"){
      $query=mysqli_query($con,"UPDATE affiliateuser SET fname='$name',password='$passs',country='$country',email='$email',address='$address' where username='".$_SESSION['adminidusername']."'");
      $errormsg= "<div class='alert alert-success'><button type='button' class='close' data-dismiss='alert'>&times;</button>
              <i class='fa fa-ban-circle'></i><strong>Success : </br></strong>Your profile has been updated.</div>"; 
              //printing error if found in validation
    }
    else{ 
      $errormsg= "<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'>&times;</button>
              <i class='fa fa-ban-circle'></i><strong>Unable to update profile details</br></strong></div>"; 
              //printing error if found in validation
    }
                ...
                <ul class="nav nav-main" data-ride="collapse">
                  ...
                  <li  class="active"> <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="i i-lab icon"> </i> <span class="font-bold">Website Configuration</span> </a>
                    <ul class="nav dk">
					  ...
					  <li> <a href="emailsettings.php" class="auto"> <i class="i i-dot"></i> <span>E-Mail Settings</span> </a> </li><li> <a href="pacsettings.php" class="auto"> <i class="i i-dot"></i> <span>Packages Settings</span> </a> </li>
                ...
                <section class="panel panel-success portlet-item">
                  ...
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      ...
                      <?php $query="SELECT * FROM  affiliateuser WHERE username='".$_SESSION['adminidusername']."'"; 
                  ...
                  <div class="panel-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" value="<?php print $name ?>" class="form-control" placeholder="" name="fullname" >
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
                        <label>Address</label>
                        <input type="text" value="<?php print $address ?>" class="form-control" placeholder="" name="address" >
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <input type="password" value="<?php print $pass ?>" class="form-control" placeholder="" name="p1" required>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-lg btn-primary btn-block" name="submit">I Have Filled And Checked All Details. Update/Edit Details For Me Now.</button>
                    </form>
                  </div>
					       </div>
                 </div>
