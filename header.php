...
<?php
			...
			<div class="mydiv1 col-md-3 col-md-offset-0 col-sm-offset-0 col-sm-4 col-xs-offset-4 col-xs-8">
				<div class="sign-login col-xs-12 ">
					<a href="signup.php" title="Sign Up"> <span class="fa fa-user-plus" id="signicon"></span>&nbsp; Sign Up </a>
					<span id="pie">|</span>
 ...
 <div class="menupatti">
	...
	<div class="menu-bar" id="menu-bar"><div class="menu-nav"><a class="fa fa-bars"></a></div></div>
